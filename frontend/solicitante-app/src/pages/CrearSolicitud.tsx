...
//         {respuesta && (
//           <div style={{ marginTop: 24, backgroundColor: '#f0f0f0', padding: 16, borderRadius: 8 }}>
//             <h4 style={{ marginBottom: 8 }}>{respuesta.mensaje}</h4>
//             <p><strong>ID Solicitud:</strong> {respuesta.solicitudId}</p>
//             <ul>
